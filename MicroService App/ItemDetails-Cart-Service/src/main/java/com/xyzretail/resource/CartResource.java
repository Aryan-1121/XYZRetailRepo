...
//		return cart;
	...
	public ItemsCart getbyIdAndUserName(@PathVariable("itemId")String itemId, @PathVariable("userName") String userName) {
...
//		return ic;
		ItemsCart cart=itemsCartService.searchByItemIdAndName(itemId, userName);
		if(cart!=null) {
			return cart;
		}
		else
